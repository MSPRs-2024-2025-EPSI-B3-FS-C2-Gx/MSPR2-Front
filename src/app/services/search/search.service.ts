...
export class SearchService {
  private searchData = [
    ...
    { title: 'Profil', route: '/client/profile', keywords: 'profil profile utilisateur user compte informations personnelles' },
    { title: 'Paramètres', route: '/client/settings', keywords: 'paramètres settings configuration préférences options' },
    { title: 'Cartographie', route: '/client/cartography', keywords: 'cartographie carte map géographie localisation zones régions' },
    { title: 'Données', route: '/client/data', keywords: 'données data statistiques chiffres informations analytics' },
    { title: 'Prédictions', route: '/client/predictions', keywords: 'prédictions predictions analyse tendances futur modèles' },
